 ...
 * @author axis
 */
public class AddMemberController extends SQLHandler implements Initializable {
    ...
    private void delete(ActionEvent event) throws SQLException {
        ...
        PreparedStatement ps = MySQLConnector.getConnection().prepareStatement(query);
        ps.setInt(1, i);
        if(DialogController.alert("Delete Household Member", "Are you sure you want to delete this member?", person.getNAME() + " from Household# "+ hhid)) {
            ps.executeUpdate();
