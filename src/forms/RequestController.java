...
import static forms.PermitController.person0;
 ...
 * @author axis
 */
public class RequestController extends SQLHandler implements Initializable {
    ...
    private void saverequest(ActionEvent event) throws IOException {
        ...
        try {
            String query = "INSERT INTO request(requester,request_details,date_time_needed,priority,request_location,recordedby) "
                    + "values(?,?,?,?,?,?)";
